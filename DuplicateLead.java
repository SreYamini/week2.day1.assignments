...
WebDriverManager.chromedriver().setup();
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("NewInfy");
		
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Sre Yamini Vijay");
		
driver.findElement(By.className("smallSubmit")).click();
		
		String titlenew = driver.getTitle();
		
		System.out.println("The title of new page is "+titlenew);
	}
